...
int main(int ac, char** av) {
    ...
    return app.run(ac, av, [&] {
        return seastar::async([&] {
            ...
            // FIXME: What we really want is the mountpoint. We should be able to transform these
            // directories into their mountpoints and then de-duplicate the mountpoints they sit in.
