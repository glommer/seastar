...
private:
    ...
    thread_cputime_clock::time_point _start_thread_runtime = thread_cputime_clock::now();
...
public:
    ...
    steady_clock_type::duration total_cpu_run_time();
    thread_cputime_clock::duration total_thread_run_time();
