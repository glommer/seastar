...
private:
    ...
    future<> register_one_priority_class(io_priority_class iop, sstring name, uint32_t shares);
...
public:
    ...
    future<io_priority_class> register_one_priority_class(sstring name, uint32_t shares);
