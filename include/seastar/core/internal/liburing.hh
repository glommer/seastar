...
private:
    ...
    uint64_t _flushes = 0;
    std::chrono::steady_clock::duration _flush_time;

    uint64_t _forced_flushes = 0;
    std::chrono::steady_clock::duration _forced_flush_time;
...
public:
    ...
    std::chrono::steady_clock::duration total_flush_time() const {
        return _flush_time;
    }

    std::chrono::steady_clock::duration total_forced_flush_time() const {
        return _forced_flush_time;
    }
