...
private:
    ...
    class epoll_pollfn;
    class kernel_events_completion_pollfn;
    class kernel_events_submission_pollfn;
    ...
    friend class kernel_events_completion_pollfn;
    friend class kernel_events_submission_pollfn;
...
public:
    ...
    void submit_io(internal::io_request req);
...
private:
    ...
    bool reap_kernel_events_completions();
    bool kernel_events_submit();
